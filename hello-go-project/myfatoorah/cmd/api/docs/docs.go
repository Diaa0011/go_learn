    ...
    "definitions": {
        ...
        "hello-go-project_myfatoorah_internal_models.Invoice": {
            ...
            "properties": {
                ...
                "source": {
                    "$ref": "#/definitions/hello-go-project_myfatoorah_internal_models.PaymentSource"
                },
                "status": {
                ...
                "type": {
                    "$ref": "#/definitions/hello-go-project_myfatoorah_internal_models.PaymentType"
                },
                "updated_at": {
                    "type": "string"
                }
        ...
        "hello-go-project_myfatoorah_internal_models.PaymentSource": {
            "type": "string",
            "enum": [
                "HOSTED",
                "EMBEDDED"
        ...
        "hello-go-project_myfatoorah_internal_models.PaymentType": {
            "type": "string",
            "enum": [
                "ONE_TIME",
                "INSTALLMENT"
